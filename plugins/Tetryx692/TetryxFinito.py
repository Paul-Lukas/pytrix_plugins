...
#--------------------------
    ...
    game_board_xLength = game_width + 4
    game_board_yLength = game_height + 4
    game_board_xPos = 0
    game_board_yPos = 0
    game_board = [[0 for i in range(30+2)] for j in range(15+2)]
    
    gb_xd = (game_board_xLength-game_width)/2
    gb_xu = game_board_xLength -gb_xd
    gb_yd = (game_board_yLength-game_height)/2
    gb_yu = game_board_yLength -gb_yd
    ...
    def game_setBorder(self):
        ...
        for x in range(self.gb_xd,self.gb_xu):
            for y in range(self.gb_yd,self.gb_yu):
