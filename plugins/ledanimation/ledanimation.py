    ...
    def run(self):
        ...
        def input(self, inp):
            if inp.get("wertaendern") == 1:
                random()
            if inp.get("wertaendern") == 2:
                reloadboardrandom(5,0,0,0)
            if inp.get("wertaendern") == 3:
                reloadboardrandom(0,5,0,0)
            if inp.get("wertaendern") == 4:
                reloadboardrandom(0,0,5,0)
            if inp.get("wertaendern") == 5:
                reloadboardrandom(0,0,0,5)
